...
def main(page: ft.Page):
    def gerar_relatorio(event):
        ...
        relatorio.text(10, 10, "Esta funcionalidade ainda está em implementação, por favor espere até a próxima versão. :)")

        print(subnets_valores)

        texto_pdf = [address, network, broadcast, firsthost, lasthost, netmask, hosts_net, subnets, subnets_valores]
        ...
        def calculo_ip(range_lista, octetos, net_mask, hostsnet, calcular, predef_mascara_info):
            ...
            match calcular:
                case True:
                    ...
                    # A estrutura abaixo funciona corretamente, apenas precisa ser adaptada a estrutura depois dessa.
                    ...
                    # Essa estrutura abaixo precisa ser adaptada à nova estrutura acima. Apenas o network está funcionando corretamente, é preciso modificar o restante (broadcast, firsthost e lasthost).
